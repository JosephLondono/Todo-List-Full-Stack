...
export default function Home() {
  return (
    <main className="flex-1 flex flex-col bg-sofka-light dark:bg-gray-900 min-h-[83vh] relative">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center px-4 py-16 text-center space-y-8">
        ...
        <button
          className="bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 text-white dark:text-gray-900 px-6 py-3 rounded-lg flex items-center gap-2 font-medium transition-colors duration-200 shadow-md hover:shadow-lg"
      ...
      {/* Features Section */}
      <section className="grid md:grid-cols-3 gap-8 px-8 py-16 bg-white/50 dark:bg-gray-800/50">
        <div className="flex flex-col items-center text-center space-y-4 p-6">
          <div className="bg-sofka-orange/20 dark:bg-sofka-orange/10 p-3 rounded-full">
      ...
      {/* CTA Section */}
      <section className="bg-gray-900 dark:bg-gray-800 text-white py-16 px-4 text-center">
